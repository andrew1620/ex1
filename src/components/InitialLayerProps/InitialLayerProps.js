...
import GetInitialLayerForm from "../GetInitialLayerForm/index";
...
const InitialLayerProps = ({ showFillProperty, btnSendClick, layer }) => {
  return <div>{/* <GetInitialLayerForm objects={obj} /> */}</div>;
};
